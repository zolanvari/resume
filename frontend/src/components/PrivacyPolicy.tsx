...
/**
 * Static privacy policy, served at /privacy. App routes here client-side, so
 * "Back to Resume Builder" returns to the builder instantly with any
 * in-progress résumé still intact.
 */
